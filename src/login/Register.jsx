...
function Register() {
  ...
  async function onSubmit() {
    const { email, password,name } = sigupDetails;
    // console.log(data);

    axios
      .post(
        "https://interview-api.onrender.com/v1/auth/register",
        {
          name:name,
          email: email,
          password: password,
        ...
        >
          ...
          <div className="input-group mb-3">
            ...
            <input
              ...
              onChange={(e) =>
                setSignDetails({ ...sigupDetails, name: e.target.value })
              }
              value={sigupDetails.name}
              aria-label="Name"
